...
const PLANT_CATEGORIES = [
  ...
  { id: 'flowering', label: '🌸 Flowers, Roses & Seasonal Blooms (Motia, Gulab, Gul-e-Firdousi)' },
  { id: 'bonsai',    label: '🎋 Bonsai & Topiary Art (Ficus Spiral, Ficus Grill)' },
  { id: 'succulent', label: '🌵 Cactus, Agave & Adenium Succulents' },
  { id: 'medicinal', label: '🌿 Medicinal, Herbal & Aromatic (Aloe Vera, Niazbo, Tulsi)' },
...
const RAW_PLANTS = [
  // NEW SEASONAL & FLOWERING BLOOMS
  { id: 'celosia-gule-kalgha', name: 'Celosia (Gul-e-Kalgha – گلِ کلغہ)', urdu: 'گلِ کلغہ', category: 'flowering', price: 270, range: '270', size: 'Seasonal Flower', sunlight: 'Full Sun', watering: 'Regular', height: '1 – 2 ft', diff: 'Easiest', pet: true, badge: '🌸 Cockscomb Bloom', desc: 'Vibrant velvety cockscomb plumes in bright red, yellow, and magenta. Excellent Pakistani seasonal garden flower.' },
  { id: 'geranium-gule-tamdani', name: 'Geranium (Gul-e-Tamdani – گلِ تمعدانی)', urdu: 'گلِ تمعدانی', category: 'flowering', price: 580, range: '580', size: 'Flowering Plant', sunlight: 'Full / Partial Sun', watering: 'Moderate', height: '1 – 2.5 ft', diff: 'Easy', pet: true, badge: '🌸 Vibrant Cluster Bloom', desc: 'Dense clusters of vivid red, pink, and white blossoms blooming continuously in pots and garden borders.' },
  { id: 'portulaca-gule-dopahari', name: 'Portulaca / Moss Rose (Gul-e-Dopahari – گلِ دوپہری)', urdu: 'گلِ دوپہری', category: 'flowering', price: 270, range: '270', size: 'Ground Cover / Seasonal', sunlight: 'Full Direct Sun', watering: 'Low', height: '0.5 – 1 ft', diff: 'Easiest', pet: true, badge: '☀️ Noon Sunlight Bloom', desc: 'Beloved Gul-e-Dopahari opening brightly under afternoon sun. Indestructible ground cover in multicolored blooms.' },
  { id: 'bird-of-paradise-firdousi', name: 'Bird Of Paradise (Gul-e-Firdousi – گلِ فردوسی)', urdu: 'گلِ فردوسی', category: 'flowering', price: 1350, range: '1,350', size: 'Exotic Flowering Plant', sunlight: 'Bright Indirect / Sun', watering: 'Moderate', height: '3 – 5 ft', diff: 'Moderate', pet: true, badge: '🦜 Exotic Crane Bloom', desc: 'Breathtaking bird-crane orange and blue exotic flowers with large banana-like glossy leaves.' },
  { id: 'african-daisy-gazania', name: 'African Daisy / Gazania (Afriqi Gul Dawoodi)', urdu: 'افریقی گلِ داؤدی', category: 'flowering', price: 600, range: '600', size: 'Seasonal Flower', sunlight: 'Full Direct Sun', watering: 'Low', height: '0.5 – 1.5 ft', diff: 'Easiest', pet: true, badge: '🌼 Sunburst Daisy', desc: 'Dazzling striped sunburst daisy flowers opening every morning with intense colors.' },
  { id: 'african-marigold-genda', name: 'African Marigold (Afriqi Marigold / Big Genda)', urdu: 'افریقی گیندا', category: 'flowering', price: 300, range: '300', size: 'Seasonal Flower', sunlight: 'Full Sun', watering: 'Regular', height: '1.5 – 3 ft', diff: 'Easiest', pet: true, badge: '🌼 Giant Orange Pom-Pom', desc: 'Large pom-pom shaped orange and yellow Marigold blooms. Traditional Pakistani winter flower.' },
  { id: 'adenium-desert-rose', name: 'Adenium Desert Rose (Flowering Succulent)', urdu: 'ایڈینیم ڈیزرٹ روز', category: 'succulent', price: 2400, range: '2,400', size: 'Flowering Succulent', sunlight: 'Full Sun', watering: 'Low', height: '1.5 – 3.5 ft', diff: 'Easy', pet: false, badge: '🌸 Sculpted Trunk Bloom', desc: 'Swollen caudex bonsai trunk bearing trumpet-shaped pink and red flowers. High-value succulent.' },
  { id: 'acalypha-red-foliage', name: 'Acalypha Red (Copper Plant / Ornamental Shrub)', urdu: 'اکالیفا سرخ', category: 'outdoor', price: 750, range: '750', size: 'Ornamental Foliage/Shrub', sunlight: 'Full / Partial Sun', watering: 'Regular', height: '2 – 5 ft', diff: 'Easy', pet: true, badge: '🔴 Copper Red Leaves', desc: 'Fiery copper-red and crimson foliage shrub adding rich color contrast to garden borders.' },
  { id: 'african-queen-lily', name: 'African Queen Lily Bulb (Lily Plant)', urdu: 'افریقی للی', category: 'flowering', price: 443, range: '443', size: 'Bulb / Flowering Plant', sunlight: 'Morning Sun', watering: 'Moderate', height: '1.5 – 3 ft', diff: 'Easy', pet: false, badge: '🤍 Fragrant Lily', desc: 'Large trumpet-shaped fragrant lily blooms growing from acclimatized bulbs.' },
  { id: 'hibiscus-gurhal-largepot', name: 'Hibiscus China Rose (Gul-e-Gurhal – 12-14" Pot)', urdu: 'گلِ گڑہل / جُوتا پھول', category: 'flowering', price: 1115, range: '620 - 1,610', size: 'Flowering Shrub (12-14" Pot)', sunlight: 'Full Sun', watering: 'Regular', height: '3 – 7 ft', diff: 'Easy', pet: true, badge: '🌺 Large Pot Gurhal', desc: 'Established multi-bloom Hibiscus China Rose in 12-14" pot bearing massive red & pink blooms.' },
  { id: 'miniature-rose-chotay', name: 'Miniature Rose Bush (Chotay Gulab)', urdu: 'چھوٹے گلاب', category: 'flowering', price: 650, range: '650', size: 'Small Flowering Plant', sunlight: 'Full Morning Sun', watering: 'Regular', height: '1 – 2 ft', diff: 'Easy', pet: true, badge: '🌹 Compact Mini Rose', desc: 'Charming mini rose bush packed with tiny fragrant red, pink, yellow, and white roses.' },
  { id: 'gallic-pink-rose', name: 'Gallic Pink Rose (Gallic Gulab)', urdu: 'گیلک گلاب', category: 'flowering', price: 650, range: '650', size: 'Flowering Plant', sunlight: 'Full Sun', watering: 'Regular', height: '2 – 4 ft', diff: 'Easy', pet: true, badge: '🌹 Heritage Pink Rose', desc: 'Classic French-heritage pink rose variety with rich old-fashioned perfume.' },
  { id: 'oleander-kaner', name: 'Oleander Shrub (Kaner – کنیر)', urdu: 'کنیر', category: 'flowering', price: 820, range: '820', size: 'Flowering Shrub', sunlight: 'Full Sun', watering: 'Low', height: '4 – 10 ft', diff: 'Easiest', pet: false, badge: '🌸 Highway Kaner Shrub', desc: 'Indestructible drought-tolerant Kaner shrub blooming in bright pink, red, and white along road borders.' },
  { id: 'gardenia-double-chand', name: 'Gardenia Double (Gul-e-Chand – گلِ چاند)', urdu: 'گلِ چاند', category: 'flowering', price: 1590, range: '1,370 - 1,810', size: 'Flowering Shrub (12-14" Pot)', sunlight: 'Morning Sun', watering: 'Regular', height: '2.5 – 5 ft', diff: 'Moderate', pet: true, badge: '🤍 Double Petal Chand', desc: 'Double-petaled snowy white Gardenia blooms with intoxicating fragrance in 12-14" pot.' },
  { id: 'kalanchoe-gule-fanoos', name: 'Kalanchoe Chandelier (Gul-e-Fanoos – گل فانوس)', urdu: 'گلِ فانوس', category: 'succulent', price: 1350, range: '1,350', size: 'Flowering Succulent', sunlight: 'Bright Indirect', watering: 'Low', height: '1 – 2 ft', diff: 'Easiest', pet: false, badge: '🏮 Chandelier Bell Bloom', desc: 'Dangling chandelier-like bell flowers over thick fleshy succulent leaves.' },
  { id: 'camellia-tree-shrub', name: 'Camellia Tree Shrub (کمیلیا)', urdu: 'کمیلیا', category: 'flowering', price: 625, range: '625', size: 'Flowering Shrub/Tree', sunlight: 'Partial Shade', watering: 'Regular', height: '3 – 8 ft', diff: 'Moderate', pet: true, badge: '🌸 Camellia Rose Bloom', desc: 'Elegant glossy dark leaves with perfect symmetrical rose-like winter blooms.' },
  { id: 'black-leaf-crape-myrtle', name: 'Black Leaf Crape Myrtle (Lagerstroemia Siyah Patti)', urdu: 'لیگرسٹرومیا سیاہ پتی', category: 'outdoor', price: 1220, range: '1,220', size: 'Flowering Shrub', sunlight: 'Full Sun', watering: 'Moderate', height: '4 – 10 ft', diff: 'Easy', pet: true, badge: '🖤 Black Leaves Red Flower', desc: 'Exotic jet-black foliage contrasting dramatically against intense crimson red flower flushes.' },
  { id: 'kochia-foliage-bush', name: 'Kochia Summer Cypress (کوچیا)', urdu: 'کوچیا', category: 'outdoor', price: 250, range: '250', size: 'Foliage/Shrub', sunlight: 'Full Sun', watering: 'Regular', height: '1.5 – 3 ft globe', diff: 'Easiest', pet: true, badge: '🟢 Soft Globe Bush', desc: 'Perfect feathery bright green globe bush turning brilliant magenta-red in autumn.' },
  { id: 'tulsi-plant-herb', name: 'Tulsi Holy Basil Plant (تلسی)', urdu: 'تلسی / نیازبو', category: 'medicinal', price: 300, range: '300', size: 'Herb / Flowering', sunlight: 'Full Sun', watering: 'Regular', height: '1 – 2.5 ft', diff: 'Easiest', pet: true, badge: '🌿 Sacred Herb', desc: 'Traditional Tulsi plant emitting calming aromatic aroma and boosting immunity.' },

  // MANGO SPECIALTY VARIETIES
