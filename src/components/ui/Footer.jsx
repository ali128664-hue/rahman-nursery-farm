...
import { MessageCircle, Phone, MapPin, ShieldCheck, Truck, CreditCard, Send } from 'lucide-react';
  ...
  return (
    <footer className="relative z-10 bg-emerald-950 text-white pt-16 pb-10 px-4 md:px-12 border-t border-amber-400/30 pointer-events-auto">
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        {/* 1. Top Shopify Newsletter & Trust Bar */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-xs">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-emerald-200 font-bold">
              <li>🍊 Commercial Fruit Saplings</li>
              <li>🪴 Indoor Air-Purifying Plants</li>
              <li>🌴 Royal Estate Date Palms</li>
              <li>🌸 Desi Roses & Motia Jasmine</li>
              <li>🌲 Timber & Shade Canopy Trees</li>
              <li>🌾 Zoysia & Bermuda Lawn Grass</li>
            </ul>
          </div>

          {/* Col 3: Customer Care & Direct Contacts */}
          <div>
            <h4 className="font-serif text-sm font-black text-amber-400 uppercase tracking-widest mb-4">
        ...
        <div className="pt-8 border-t border-emerald-900 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-emerald-300 font-bold">
          <div>
            © {new Date().getFullYear()} Rahman Nursery Farm. Official Shopify-Style Botanical Storefront.
          </div>
